...
echo "=========================================================="
echo "Starting Region Proposals & Fast R-CNN Learning Center..."
echo "=========================================================="
...
"${PYTHON_CMD[@]}" -c "
libs = ['flask', 'torch', 'torchvision', 'cv2', 'numpy', 'PIL']
missing = []
for lib in libs:
    try:
        __import__(lib)
...
" || {
    ...
    echo "Please install them using: conda run -n sliding_window_env pip install flask torch torchvision opencv-python numpy pillow" >&2
    exit 1
}

echo "All dependencies verified successfully."
echo "Launching Flask backend..."
echo "Open your browser and navigate to: http://127.0.0.1:5003"
